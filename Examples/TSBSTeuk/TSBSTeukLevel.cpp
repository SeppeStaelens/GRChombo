...
#include "TSBosonStarTeukolskyWave.hpp"
...
void TSBSTeukLevel::specificAdvance()
{
...
void TSBSTeukLevel::initialData()
{
    CH_TIME("TSBSTeukLevel::initialData");
    if (m_verbosity)
        pout() << "TSBSTeukLevel::initialData " << m_level << endl;
...
void TSBSTeukLevel::preCheckpointLevel()
{
    CH_TIME("TSBSTeukLevel::preCheckpointLevel");
...
void TSBSTeukLevel::prePlotLevel()
{
    CH_TIME("TSBSTeukLevel::prePlotLevel");
...
void TSBSTeukLevel::specificEvalRHS(GRLevelData &a_soln, GRLevelData &a_rhs,
                                     const double a_time)
{
    // Enforce trace free A_ij and positive chi and alpha
    BoxLoops::loop(make_compute_pack(TraceARemoval(), PositiveChiAndAlpha()),
...
void TSBSTeukLevel::specificUpdateODE(GRLevelData &a_soln,
...
void TSBSTeukLevel::specificPostTimeStep()
{
    CH_TIME("TSBSTeukLevel::specificPostTimeStep");
        ...
        m_level == m_p.mass_extraction_params.min_extraction_level())
    {
        if (m_verbosity)
        {
            pout() << "TSBSTeukLevel::specificPostTimeStep:"
                      " Extracting mass."
                   << endl;
        }
