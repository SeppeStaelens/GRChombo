...
void BHBSLevel::initialData()
{
    CH_TIME("BHBSLevel::initialData");
    if (m_verbosity)
...
void BHBSLevel::preCheckpointLevel()
{
    CH_TIME("BHBSLevel::preCheckpointLevel");
...
void BHBSLevel::specificEvalRHS(GRLevelData &a_soln, GRLevelData &a_rhs,
                                       const double a_time)
{
    // Enforce trace free A_ij and positive chi and alpha
    BoxLoops::loop(
...
void BHBSLevel::specificUpdateODE(GRLevelData &a_soln,
...
void BHBSLevel::computeTaggingCriterion(
    ...
    const FArrayBox &current_state_diagnostics)
{
    ...
    {
        const vector<double> puncture_radii = {m_p.tag_radius_BS,
                                                m_p.tag_radius_BH};
